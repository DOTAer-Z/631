    ...
    <div class="step-content">
      ...
      <div v-else-if="step === 1">
        ...
        <el-table ref="testTable" :data="testRows" row-key="version_id" size="small" v-loading="testLoading" @select="handleSelect" @select-all="handlePageSelectAll">
          ...
          <el-table-column prop="platform" label="平台" width="105" />
...
import { buildSplitPreviewPayload, buildTaskPayload, createTrainingForm, validateTaskForm } from '../trainingForm'
