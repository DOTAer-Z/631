...
export const analyzeApi = (data) => request.post('/log-analysis/analyze/api', data)
...
export const uploadLogApi = (data) => request.post('/log-analysis/upload/api', data)
...
export const analyzeLog = (data) => {
  if (data instanceof FormData) {
    ...
    // 接口导入方式
    return request.post('/log-analysis/analyze/api', data)
  } else {
    // 默认调用
    return request.post('/log-analysis/analyze', data)
  }
