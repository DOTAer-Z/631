...
// jsonl 导入任务：进度查询 + 取消
export const getJsonlTask = (importId) => request.get(`/data-imports/${importId}/jsonl-task`)
export const cancelJsonlTask = (importId) => request.post(`/data-imports/${importId}/jsonl-task/cancel`)
